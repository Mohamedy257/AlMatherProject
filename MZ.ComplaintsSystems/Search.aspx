<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="MZ.ComplaintsSystems.Search" %>
...
<CellStyle CssClass="row"></CellStyle>
                                        ...
                                        <dx:GridViewDataTextColumn VisibleIndex="0" Caption="#">
                                            <DataItemTemplate>
                                                <a target="_blank" href='<%#"/Editcomplaints.aspx?Id="+Eval("ID").ToString()%>'>تحديد</a>
