<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Site.Master" AutoEventWireup="true" CodeBehind="Search2.aspx.cs" Inherits="MZ.ComplaintsSystems.Search2" %>
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" Width="100%" RightToLeft="True" runat="server" EnableTheming="True" Theme="Office2010Blue" AutoGenerateColumns="False">
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn VisibleIndex="0" Caption="#">
                                        <DataItemTemplate>
                                            <a href='<%#"/ComplaintFinalization.aspx?Id="+Eval("ID").ToString()%>'>تحديد</a>
